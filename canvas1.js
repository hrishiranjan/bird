var Birds = function()
{
    ...
    var prepare = function()
    {
        ...
        bgTop = engine.createLinearGradient(255, 255, 255, height / 2);
        bgTop.addColorStop(0, "black");
        bgTop.addColorStop(1, "black");

        bgBot = engine.createLinearGradient(255, height / 2, 255, height);
        bgBot.addColorStop(0, "black");
        bgBot.addColorStop(1, "black");
    };
    ...
    {
        engine.fillStyle = '#ef4d19';
        // engine.fillStyle = 'hsl(' + (frame % 360) +  ', 10%, 10%)';
    ...
    var drawShine = function()
    {
        ...
        // engine.fillStyle = 'rgba( + ( 'frame % 360) +' , 124, 211, 1)';/
    ...
    var createBirds = function()
    {
        ...
        for (var i = 0; i < config.number; i++) {
            ...
            birds.push({
                ...
                speed : (0.8 + Math.random() * 0.8) / 2000,
                pos : {
